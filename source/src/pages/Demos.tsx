    ...
    <div className="container">
      <div className="page-header">
        ...
        <p className="page-subtitle">
          Interactive examples showing what you can build with Yeti.<br />Each demo runs as a standalone application. See how these building blocks come together in <Link to="/solutions/media-security">real-world scenarios</Link>.
        </p>
      </div>
